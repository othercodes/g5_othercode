...
<div id="oc-simplecontactform" class="<?php echo $moduleclass_sfx ?>">
    ...
    <form id="oc-form" name="oc-form" method="post" enctype="multipart/form-data">
        ...
        <div class="control-group">
            <div class="controls">
                <button type="submit" class="btn btn-primary validate"><?php echo JText::_('MOD_SIMPLECONTACTFORM_SUBMIT'); ?></button>
                <?php if ($reset === '1') { ?>
                    <button type="reset" class="btn btn-primary validate"><?php echo JText::_('MOD_SIMPLECONTACTFORM_RESET'); ?></button>
                <?php } ?>
            </div>
        </div>
    </form>
